    ...
    >
      <div className="flex flex-col p-4 justify-center max-w-screen-lg mx-auto h-full">
        <div className="pb-8">
          ...
          <p className="py-6">Hey, I’m currently looking for any new opportunities,
          If you have anything for me , my inbox is always open. </p>
        </div>
        <a href="mailto:vinayygaharwar@gmail.com" target="_blank">
